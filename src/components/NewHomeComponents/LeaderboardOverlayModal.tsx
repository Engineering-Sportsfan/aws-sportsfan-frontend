...
export type LeaderboardTab = "global" | "quiz" | "roar" | "campus";
...
export default function LeaderboardOverlayModal({
  ...
  useEffect(() => {
    if (isOpen) {
      if (activeTab === "quiz") fetchQuizLeaderboard();
    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="w-full max-w-xl bg-[#0b0e17] border border-white/10 rounded-2xl sm:rounded-3xl shadow-[0_20px_70px_rgba(0,0,0,0.9)] flex flex-col overflow-hidden max-h-[88vh] relative"
        >
          {/* Top Accent Line */}
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="flex items-center gap-2">
                  <h2 className="text-base font-black tracking-tight text-white">Arena Leaderboards</h2>
                  <span className="text-[9px] font-black bg-gradient-to-r from-pink-500 to-orange-500 text-white px-2 py-0.5 rounded-full tracking-wider">
                    GLOBAL
                  </span>
                </div>
                <p className="text-[11px] text-white/40 font-medium">Rankings across Fanzone, Quiz, ROAR & Campus</p>
              </div>
            </div>
          ...
          <div
            className="p-3 sm:p-4 flex-1 overflow-y-auto space-y-4"
